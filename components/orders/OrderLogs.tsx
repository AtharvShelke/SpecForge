  ...
  if (sortedLogs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-10 px-4">
        ...
        <p className="text-xs font-semibold text-stone-500 mb-0.5">No Status History</p>
        <p className="text-[11px] text-stone-400">Status changes will appear here as the order progresses.</p>
      </div>
    );
  }
              ...
              <div>
                ...
                {log.note && (
                  <div className="mt-1.5 flex items-start gap-1.5 bg-stone-50 px-2.5 py-2 rounded-lg border border-stone-100">
                    <FileText size={10} className="text-stone-400 mt-0.5 flex-shrink-0" />
