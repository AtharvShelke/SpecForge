...
function buildPills(
  summary: NonNullable<CompatibilityResult["summary"]>,
): StatPill[] {
  return [
    {
      label: "Total",
...
const CompatibilitySummary: React.FC<CompatibilitySummaryProps> = memo(
  ({ summary }) => {
    if (!summary) {
      return (
              ...
              <div className="h-full flex">
                ...
                {summary.errors > 0 && (
                  <div
                    ...
                    style={{
                      width: `${(summary.errors / summary.totalChecks) * 100}%`,
                    }}
                  />
                )}
