                            ...
                            >
                               ...
                               <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-12">
                                    {FEATURES.slice(0, 2).map((feat, i) => (
                                        <div key={i} className="flex flex-col gap-3">
                                            <div className="w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center">
                                                <feat.icon size={16} className="text-indigo-400" />
                                            </div>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link
                                        href="/builds/create"
                                        className="group inline-flex items-center gap-3 px-5 py-2.5 sm:px-6 sm:py-3 md:px-8 md:py-4 rounded-lg sm:rounded-full font-semibold bg-white text-zinc-950 uppercase tracking-wide
