    ...
    return (
        <footer className="relative bg-zinc-950 text-white overflow-hidden mt-auto pb-16 md:pb-0">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-40">
                ...
                <div className="absolute top-[60%] -right-[10%] w-[40%] h-[60%] rounded-full bg-violet-900/30 blur-[120px]" />
            </div>

            <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">

                {/* Top Section / Call to Action */}
                <div className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center border-b border-white/10 pb-16">
                    <div>
                ...
                {/* Links & Brand Section */}
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8 border-b border-white/10 pb-16 mb-8">
                    ...
                    <div className="md:col-span-1 border-r-0 md:border-r border-white/10 pr-8">
                        <Link href="/" className="flex items-center gap-2.5 group mb-6">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 border border-white/20 shadow-sm transition-transform group-hover:scale-110">
                    ...
                    <div>
                        <h3 className="font-semibold text-white tracking-wider uppercase text-sm mb-6 flex items-center gap-2">
